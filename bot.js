...
function claimDailyReward() {
    ...
    setTimeout(claimDailyReward, Math.random() * 2000 + 5000);
}
...
try {
	...
	setTimeout(answerQuestion, Math.random() * 1000 + 2000);
	...
	setTimeout(videoTaskCompletion, Math.random() * 1000 + 3000);
	...
	function AutoClaimAndStart() {
		...
		setTimeout(AutoClaimAndStart, Math.floor(Math.random() * 5000) + 5000);
	}
